...
def test_a_download_lands_under_its_final_name(tmp_path, monkeypatch):
    """The partial file never survives, so a caller cannot be handed a half-written archive by a
